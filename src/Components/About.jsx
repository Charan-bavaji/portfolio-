            ...
            <div className=" w-[85%] h-[auto] rounded-2xl  md:w-[80%] lg:w-[80%] -z-0 backdrop-blur-sm bg-black/1 flex flex-col gap-6 lg:gap-10">
                ...
                <div className=' ml-[10%] sm:ml-[15%]'>
                    <div>
                        ...
                        <p className='text-justify md:text-lg'> As a motivated and skilled <span className='text-[#ffef88] font-semibold'>front-end developer</span> in the  early stages of my career.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className='text-justify md:text-lg'>I have hands-on experience in building projects that showcase my versatility, such as...
                            <li>
